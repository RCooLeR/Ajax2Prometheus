...
Ajax2Prometheus already publishes enough MQTT discovery entities to build a good-looking Lovelace dashboard without extra backend work.
...
1. Let Ajax2Prometheus publish MQTT discovery once.
...
This repo also includes [ha-detailed-devices.yaml](./ha-detailed-devices.yaml), a full detailed Lovelace view generated from the current `data/devices.json`.
